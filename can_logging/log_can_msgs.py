...
"JVMheartbeat", "JVMALerts", "GutterSprayOnOff", "AddWaterSprayOnOff", "WaterRe_circOnOff", "modbus_id", "pm_sensor_serious_fault", "pm_sensor_fault", "pm_sensor_is_degraded_mode", 
